...
public class CollegesActivity extends AppCompatActivity {
    ...
    private static final String TAG = CollegesActivity.class.getSimpleName();
    private ListView listView;
    private FeedListAdapter listAdapter;
    private List<FeedItem> feedItems;
    private Intent intent;
    private String URL_FEED = "https://raw.githubusercontent.com/Austrie/EducationHub/master/jsonStuff/colleges.json";
    ...
    private void parseJsonFeed(JSONObject response) {
        try {
            ...
            for (int i = 0; i < feedArray.length(); i++) {
                ...
                item.setName(feedObj.getString("college"));
...
//                item.setImge(image);
                ...
                item.setTimeStamp(feedObj.getString("deadline"));
