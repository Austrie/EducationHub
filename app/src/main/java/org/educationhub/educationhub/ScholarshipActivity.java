...
public class ScholarshipActivity extends AppCompatActivity {
    private static final String TAG = ScholarshipActivity.class.getSimpleName();
    private ListView listView;
    private FeedListAdapter listAdapter;
    private List<FeedItem> feedItems;
    private Intent intent;
    private String URL_FEED = "https://raw.githubusercontent.com/Austrie/EducationHub/master/jsonStuff/scholarships.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.scholarshipList);
...
//                item.setImge(image);
                ...
                item.setTimeStamp(feedObj.getString("due"));
